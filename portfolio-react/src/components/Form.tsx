...
export default function Form() {
    return (
        <div className="flex flex-col items-center justify-center w-full max-w-5xl p-8">
            <form className="flex flex-col gap-8 w-full max-w-4xl">
                ...
                className="bg-[var(--main-bg-color)] text-white p-4 rounded-lg shadow-[0px_0px_20px_rgba(37,99,235,0.5)] 
                focus:outline-none focus:shadow-[0px_0px_20px_rgba(37,99,235,1)] transition-all ease-in-out duration-300 resize-none h-32 mb-6">
                </textarea>
