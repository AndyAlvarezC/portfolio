...
const SkillCard: React.FC<SkillCardsProps> = ({ title, size, icon: Icon, color }) => {
  return (
    ...
    <div
      ...
      style={{ boxShadow: '0 10px 40px -10px rgba(0, 0, 0, 0.1)' }} // subtle shadow for depth
    >
      ...
      {/* Skill title with gradient text effect on hover */}
      <h3 className="relative z-10 text-lg md:text-xl font-bold text-gray-900 group-hover:bg-linear-to-br group-hover:from-blue-600 group-hover:via-indigo-600 group-hover:to-purple-600 group-hover:bg-clip-text group-hover:text-transparent transition-all duration-500">
        {title}
      </h3>
