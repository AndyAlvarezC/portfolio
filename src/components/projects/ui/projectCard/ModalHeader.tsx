  ...
  ({ title, image, onClose }) => {
    return (
      <div className="relative h-60 overflow-hidden rounded-t-3xl">
        ...
        <button
          onClick={onClose}
          className="absolute top-6 right-6 z-20 bg-white/10 backdrop-blur-md hover:bg-white/20 p-3 rounded-full shadow-lg transition-all duration-200 hover:scale-110 border border-white/20 cursor-pointer"
