...
export default function Home() {
  return (
    <>
      <section
        id="home"
        className="w-full min-h-screen flex flex-col items-center justify-center text-center gap-y-6 px-6 scroll-mt-20"
      >
          ...
          <div className="mt-32">
            <button
              ...
              className="bg-[var(--main-color)] text-white text-xl md:text-2xl font-bold uppercase tracking-wide 
                    py-4 px-10 rounded-lg shadow-lg transition duration-300 ease-in-out 
